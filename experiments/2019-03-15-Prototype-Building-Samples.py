...
base_path = '/Users/michael/Dropbox/PhD/Python/Experiments/mechanical-model/2018-12-20/A/'
...
# Samples_a = []
# for lvp, aep in zip(labeled_video_paths, acc_emf_paths):
#     video_labels_df = pd.read_csv(lvp)
#     acc_emf_df = pd.read_csv(aep)
#     Samples_a.append(Sample(acc_emf_df, video_labels_df))
