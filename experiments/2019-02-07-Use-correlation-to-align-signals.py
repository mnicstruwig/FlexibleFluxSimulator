...
df_A_1_adc = pd.read_csv(
    "/home/michael/Dropbox/PhD/Python/unified_model/notebooks/2018-12-20/A/log_17.csv"
)
df_A_2_adc = pd.read_csv(
    "/home/michael/Dropbox/PhD/Python/unified_model/notebooks/2018-12-20/A/log_18.csv"
)
...
y_relative_mm, timestamps = lp.fit_transform(
    df_label, impute_missing_values=True, pixel_scale=pixel_scale
)
...
# Simulate the system
emf_pred, timestamps_pred = simulate_electrical_system(
    y_relative_mm, timestamps, flux_model, load_model, True
)
