...
# ABC DEVICES
abc_coil_center = {"A": 59, "B": 61, "C": 63}

# Is now calculated by the coil model, but we override it to make real-world
# measurements
abc_coil_resistance = {"A": 12.5, "B": 23.5, "C": 17.8}

abc_winding_num_r = {"A": "15", "B": "15", "C": "5"}

abc_winding_num_z = {"A": "17", "B": "33", "C": "66"}

abc_coil_height = {"A": "0.008meter", "B": "0.012meter", "C": "0.014meter"}

abc_magnet_assembly = MagnetAssembly(
    m=1,
    l_m_mm=10,
    l_mcd_mm=0,
    dia_magnet_mm=10,
...
abc_spring_fea_data_path = os.path.join(
    base_dir, "../data/magnetic-spring/10x10alt.csv"
)
abc_spring = MagneticSpringInterp(
    fea_data_file=abc_spring_fea_data_path,
